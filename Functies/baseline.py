...
def collect_baselines(iterations, num_runs, min, max, stations_path, connections_path):
    """
    ...
    for run in range(num_runs):
        ...
        quality_dict = baseline(iterations, min, max, stations_path, connections_path)
