...
def random_multiple_trajects(traject_type, min, max, stations_path, connections_path):
    """
    ...
    trajects, cost = multiple_trajects(nr, traject_type, stations_path, connections_path)
