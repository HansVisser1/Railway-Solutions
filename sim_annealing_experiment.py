...
def plot_sim_annealing_temp_test(file='simulated_annealing_temp_test.csv'):
    ...
    plt.title('Quality by Temperature and Cooling Rate. Simulated Annealing (1000 iterations)')
...
# sim_annealing_temperature_test(100, 0, 650, 50, 0.9980, 0.9999, 0.0001, 10000, stations_nl, connections_nl, 1, 20)
